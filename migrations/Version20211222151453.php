 ...
 */
final class Version20211222151453 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'modification de blogpost et mise en relation de User et BlogPost';
    }

    public function up(Schema $schema): void
    {
        // this up() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE blog_post ADD user_id INT NOT NULL, ADD datetime DATETIME NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE blog_post DROP user_id, DROP datetime');
    }
}
